...
public static String  _enviar() throws Exception{
RDebugUtils.currentModule="starter";
if (Debug.shouldDelegate(processBA, "enviar"))
	 {return ((String) Debug.delegate(processBA, "enviar", null));}
RDebugUtils.currentLine=4653056;
 //BA.debugLineNum = 4653056;BA.debugLine="Public Sub enviar()";
RDebugUtils.currentLine=4653057;
 //BA.debugLineNum = 4653057;BA.debugLine="ast.Write(\"A\" & Main.dni & \"P\" &  IngresarCascoID";
...
RDebugUtils.currentLine=4653058;
 //BA.debugLineNum = 4653058;BA.debugLine="Log(\"enviar DNI: \" & Main.dni )";
anywheresoftware.b4a.keywords.Common.Log("enviar DNI: "+mostCurrent._main._dni);
RDebugUtils.currentLine=4653059;
 //BA.debugLineNum = 4653059;BA.debugLine="Log(\"enviar ID casco: \" & IngresarCascoID.IDcasco";
anywheresoftware.b4a.keywords.Common.Log("enviar ID casco: "+mostCurrent._ingresarcascoid._idcasco);
RDebugUtils.currentLine=4653060;
 //BA.debugLineNum = 4653060;BA.debugLine="Log(\"A\"&Main.dni&\"P\"&IngresarCascoID.IDcasco&Chr(";
