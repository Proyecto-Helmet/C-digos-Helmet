...
public static RemoteObject  _enviar() throws Exception{
try {
		Debug.PushSubsStack("enviar (starter) ","starter",7,starter.processBA,starter.mostCurrent,89);
if (RapidSub.canDelegate("enviar")) { return b4a.HelmetAPPV3.starter.remoteMe.runUserSub(false, "starter","enviar");}
 BA.debugLineNum = 89;BA.debugLine="Public Sub enviar()";
